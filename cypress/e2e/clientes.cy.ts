...
describe("Clientes - Inativar/Ativar", () => {
  it("deve inativar e ativar um cliente com sucesso", () => {
    ...
    cy.intercept("GET", "**/clientes", [
      { id: 1, nome: "Felipe Lopes", email: "felipe@email.com", telefone: "(11) 99999-9999", ativo: true }
    ]).as("listClientes")

    // Mock da requisição de inativar
    cy.intercept("PUT", "**/clientes/1/inativar", { statusCode: 200 }).as("inativarCliente")

    // Mock da requisição de ativar
    cy.intercept("PUT", "**/clientes/1/ativar", { statusCode: 200 }).as("ativarCliente")
...
describe("Clientes - Editar", () => {
  it("deve editar os dados de um cliente com sucesso", () => {
    ...
    // Mock da atualização
    cy.intercept("PUT", "**/clientes/1", { statusCode: 200 }).as("updateCliente")
    ...
    cy.wait("@updateCliente").its("request.body").should((body) => {
