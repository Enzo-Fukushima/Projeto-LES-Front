...
import { mockBooks, getBooksByCategory } from "@/lib/mock-data"
...
export default function HomePage() {
  ...
  const filteredBooks = selectedCategory ? getBooksByCategory(selectedCategory) : mockBooks
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary/10 to-primary/5 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-balance mb-6">Sua Biblioteca Digital</h1>
          <p className="text-xl text-muted-foreground text-balance mb-8 max-w-2xl mx-auto">
            Descubra milhares de livros com recomendações personalizadas por IA. A melhor experiência de compra online
      ...
      <section id="catalog" className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-balance mb-4">Nosso Catálogo</h2>
            <p className="text-muted-foreground text-balance max-w-2xl mx-auto">
              Explore nossa seleção cuidadosa de livros organizados por categoria
            </p>
          </div>
